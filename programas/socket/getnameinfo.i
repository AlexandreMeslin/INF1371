# 0 "getnameinfo.c"
# 1 "/home/meslin/Documents/Documents-Windows/Cursos/Programação UNIX/programas/socket//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 12 "getnameinfo.c"
 ...
 if(argc != 2) {
  fprintf(
# 21 "getnameinfo.c" 3 4
         stderr
# 21 "getnameinfo.c"
               , "Uso: getnameinfo <endereco ip>\n");
  return 1;
 }
 ...
 hints.ai_family = (strchr(host, ':') ? 
# 30 "getnameinfo.c" 3 4
                                       10 
# 30 "getnameinfo.c"
                                                : 
# 30 "getnameinfo.c" 3 4
...
# 30 "getnameinfo.c"
 ...
 hints.ai_socktype = 
# 31 "getnameinfo.c" 3 4
                    SOCK_STREAM
# 31 "getnameinfo.c"
                               ;
 hints.ai_flags |= 
# 32 "getnameinfo.c" 3 4
                  0x0004
# 32 "getnameinfo.c"
                                ;
 if((erro = getaddrinfo(host, ((char *) 0), &hints, &res0)) != 0) {
  fprintf(
# 34 "getnameinfo.c" 3 4
         stderr
# 34 "getnameinfo.c"
 ...
 for(res = res0; res != 0; res = res->ai_next) {
  ...
  erro = getnameinfo(res->ai_addr, res->ai_addrlen,
      ...
      ((char *) 0), 0, 
# 45 "getnameinfo.c" 3 4
                    8
# 45 "getnameinfo.c"
                               );
  if(erro) {
   fprintf(
# 47 "getnameinfo.c" 3 4
          stderr
# 47 "getnameinfo.c"
                , "[getnameinfo] %s: %s\n", host, gai_strerror(erro));
   return 1;
